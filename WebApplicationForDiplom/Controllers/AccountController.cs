...
using WebApplicationForDiplom.Providers;
using WebApplicationForDiplom.Results;
...
namespace WebApplicationForDiplom.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            if (!result.Succeeded)
            {
                return GetErrorResult(result);//важно
            }
        ...
        private IHttpActionResult GetErrorResult(IdentityResult result)
        {
            ...
            if (!result.Succeeded)
            {
                if (result.Errors != null)
                {
                    ...
                    {
                        ModelState.AddModelError(error.ToString(), error);
                    }
                }
